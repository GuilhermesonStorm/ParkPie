      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Preço / hora: {Intl.NumberFormat('pt-br',{style: 'currency', currency: 'BRL'}).format(parkingLot.price_hour)}</Text>
          </View>
        </View>
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            <Feather name='clock' size={40} color='#2AB5D1' />
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>Segunda à Sexta {parkingLot.time_opening} às {parkingLot.time_closing}</Text>
          </View>
        </View>
